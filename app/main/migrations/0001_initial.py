    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.IntegerField()),
                ('cheque_reference', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.cheque')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customer_product_price_id', models.AutoField(primary_key=True, serialize=False)),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
